...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("abhigyag/ipinfo")
    client.subscribe("abhigyag/date")
    client.subscribe("abhigyag/time")

    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("abhigyag/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("abhigyag/date", on_message_from_date)
    client.message_callback_add("abhigyag/time", on_message_from_time)
