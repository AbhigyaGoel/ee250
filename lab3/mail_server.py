...
def add_mail(mail_entry: Dict[str, str]) -> str:
    """Adds a mail entry to the json file
...
def get_mail(mail_id: str) -> Optional[Dict[str, str]]:
    """Fill out this docstring (using the load_mail docstring as a guide)
    Gets a specific mail entry from the json file
...
def get_sent(sender: str) -> List[Dict[str, str]]:
    """Fill out this docstring (using the load_mail docstring as a guide)
    Gets all sent mail entries for a sender from the json file
